...
Le rapport est généré dans `.analysis-reports/impact_<nom-release>.html`
...
```bash
OUTPUT_FILE=".analysis-reports/impact_${RELEASE_NAME}.html"
...
Rapport généré : .analysis-reports/impact_v27.0.0.html
