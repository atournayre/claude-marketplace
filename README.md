...
| ⚙️ **Dev** | 2.1.1 | Workflow structuré 8 phases + toolkit complet | [README](dev/README.md) |
| 🔧 **Git** | 1.7.0 | Workflow Git complet : branches, commits, conflits, PR avec labels CD + issue labels | [README](git/README.md) |
