...
| 🔧 **Git** | 1.12.1 | Workflow Git complet : branches, commits, conflits, PR, fix-pr-comments + Task Management System | [README](git/README.md) |
...
| 📝 **Prompt** | 2.1.0 | Système hybride Starters + Mode Plan + Checklists + Agent Teams - Templates légers, exploration contextuelle, validation automatisée, orchestration multi-agents | [README](prompt/README.md) |
