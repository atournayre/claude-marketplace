...
| ⚙️ **Dev** | 2.2.1 | Workflow structuré 8 phases + mode automation non-interactif | [README](dev/README.md) |
| 🔧 **Git** | 1.7.7 | Workflow Git complet : branches, commits, conflits, PR avec automation | [README](git/README.md) |
