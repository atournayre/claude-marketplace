...
| ⚙️ **Dev** | 2.2.0 | Workflow structuré 8 phases + mode automation non-interactif | [README](dev/README.md) |
| 🔧 **Git** | 1.7.4 | Workflow Git complet : branches, commits, conflits, PR avec labels CD + issue labels | [README](git/README.md) |
